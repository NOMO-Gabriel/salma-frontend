...
export interface NavContact { title: string; rdv_label: string; rdv_desc: string; whatsapp_label: string; whatsapp_desc: string; newsletter_title: string; newsletter_desc: string; newsletter_placeholder: string; newsletter_btn: string; }
