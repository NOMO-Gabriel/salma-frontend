...
// Changement : dictionary.trust.* → cmsSwitcher.getScopeContent("home", locale)
// Style : 100% identique à l'original
...
export default function TrustBar() {
  ...
  if (!trust) return (
    <section className="relative z-20 -mt-10 px-6">
      <div className="max-w-6xl mx-auto bg-white dark:bg-salma-surface border border-salma-border shadow-salma-lg rounded-3xl overflow-hidden h-[120px] animate-pulse" />
    </section>
  );
